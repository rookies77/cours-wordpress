...
<h2><?php printf( esc_html__( 'Notes', 'services' ) ); ?></h2>
...
<p><?php printf( esc_html__( 'This theme hides sidebars by default. To enable, add the following CSS:', 'services' ) ); ?></p>
<pre><code>#content{width:75%;padding:4%;float:left}</code></pre>
<pre><code>#sidebar{display:block;width:25%;padding:4% 4% 4% 0;float:right}</code></pre>
</div>
<?php
}