...
<a href="<?php echo esc_url( get_permalink( $post->post_parent ) ); ?>" title="<?php printf( esc_html__( 'Return to %s', 'services' ), esc_html( get_the_title( $post->post_parent ), 1 ) ); ?>" rev="attachment"><?php esc_html_e( 'Return to', 'services' ); ?> <?php echo wp_kses_post( get_the_title( $post->post_parent ) ); ?></a>
