...
<?php
$enable_content = get_theme_mod( 'travelore_featured_content_option', 'disabled' );
...
$featured_posts = travelore_get_posts( 'featured_content' );
...
$title     = get_option( 'featured_content_title', esc_html__( 'Contents', 'travelore' ) );
