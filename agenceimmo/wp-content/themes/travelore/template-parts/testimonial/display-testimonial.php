...
<?php
$enable = get_theme_mod( 'travelore_testimonial_option', 'disabled' );
...
$jetpack_defaults = array(
	'page-title' => esc_html__( 'Testimonials', 'travelore' ),
);

// Get Jetpack options for testimonial.
$jetpack_options = get_theme_mod( 'jetpack_testimonials', $jetpack_defaults );

$headline = isset( $jetpack_options['page-title'] ) ? $jetpack_options['page-title'] : esc_html__( 'Testimonials', 'travelore' );
...
<div id="testimonial-content-section" class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>">
	...
	<?php endif; ?>
		...
		<div class="section-content-wrapper testimonial-content-wrapper layout-one testimonial-slider owl-carousel">
			<?php
